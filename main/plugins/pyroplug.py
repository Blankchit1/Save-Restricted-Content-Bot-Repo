        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            file = await userbot.download_media(
                ...
                progress_args=(
                    client,
                    "**__Unrestricting__: __[🕸️𓆩𝐁𝐋𝐚𝐧𝐊𝐂𝐇𝐈𝐭𓆪🧸MvMahanta](https://t.me/neetbrandmedprep)__**\n ",
                    edit,
                    time.time()
                )
            )  
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg', 'ts', 'avi', 'flv', 'org']:
                ...
                caption = f"{msg.caption}\n\n__Unrestricted by **[🕸️𓆩𝐁𝐋𝐚𝐧𝐊𝐂𝐇𝐈𝐭𓆪🧸MvMahanta](https://t.me/neetbrandmedprep)**__" if msg.caption else "__Unrestricted by **[🕸️𓆩𝐁𝐋𝐚𝐧𝐊𝐂𝐇𝐈𝐭𓆪🧸MvMahanta](https://t.me/neetbrandmedprep)**__"
                await send_video_with_chat_id(client, sender, path, caption, duration, hi, wi, thumb_path, upm)
            elif str(file).split(".")[-1] in ['jpg', 'jpeg', 'png', 'webp']:
                if file_n != '':
                    #path = ''
                ...
                caption = f"{msg.caption}\n\n__Unrestricted by **[ 🕸️𓆩𝐁𝐋𝐚𝐧𝐊𝐂𝐇𝐈𝐭𓆪🧸MvMahanta](https://t.me/neetbrandmedprep)**__" if msg.caption else "__Unrestricted by **[🕸️𓆩𝐁𝐋𝐚𝐧𝐊𝐂𝐇𝐈𝐭𓆪🧸MvMahanta](https://t.me/neetbrandmedorep)**__"
                await upm.edit("__Uploading photo...__")
